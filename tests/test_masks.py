...
@pytest.mark.parametrize(
    "incorrect_card_number, wrong_number", [("", wrong_number_card),
...
def test_get_mask_account(incorrect_account, wrong_account):
